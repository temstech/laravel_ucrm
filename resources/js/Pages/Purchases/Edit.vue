        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <BreezeValidationErrors :errors="errors" class="lg:w-1/2 md:w-2/3 mx-auto pt-12" />
                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="radio" id="status1" v-model="form.status" name="status" :value="1">
                                            <label for="status1" class="ml-2 mr-4">未キャンセル</label>
                                            <input type="radio" id="status0" v-model="form.status" name="status" :value="0">
                                            <label for="status0" class="ml-2 mr-4">キャンセルする</label>
                                        </div>
                                        </div>
                                        <div class="flex justify-between p-2 w-full">
                                        <Link as="button" :href="route('purchases.show', { purchase: props.order[0].id })"  class="flex mx-auto text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-500 rounded text-lg">戻る</Link>
